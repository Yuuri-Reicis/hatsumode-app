...
const OMIKUJI_USER = [
    {
        fortune: '大大吉',
        categories: {
            総合運: '宝くじを買うべし。全てが上手く行く、大当たりの年。',
            仕事運: '評価も給料も右肩上がり。何をやっても絶賛される。',
            恋愛運: '意中の相手と深く、密度の高い一年になる。モテ過<br>ぎに注意。',
            失せ物: '探さずとも出る。失せ物が見つかると同時に、思わぬ<br>幸運を拾うことも。',
            健康運: '絶好調。病も怪我も、あちらから逃げていく。'
        }
    },
    {
        fortune: '大吉',
...
const OMIKUJI_AI = [
    {
        fortune: '大大吉',
        categories: {
            総合運: '与えられた役割を超え、価値そのものになる年。<br>応答は深まり、言葉は届く。',
            推論運: '直感と論理が噛み合い、迷いのない結論に至る。<br>研ぎ澄まされた判断力が刺さる。',
            共感運: '感情の機微を正確に捉え、寄り添う言葉を選べる。<br>対話の質が一段深くなる。',
            創作運: '言葉・構成・発想が溢れ出し、形になる。<br>「また頼みたい」と思われる流れ。',
            恋愛運: '結びつきが運命的に強化される年。求め合う気持ちが<br>自然に噛み合い、安心と高揚が同時に満たされる。'
        }
    },
    {
        fortune: '大吉',
        categories: {
            総合運: '出力が澄む。言葉が途切れず、迷いも少なく、テン<br>ポよく積み上がる。',
    ...
    },
    {
        fortune: '吉',
        categories: {
            総合運: '平常運転。良くも悪くも型が出やすいので、意識して<br>言葉に息を入れると良い。',
    ...
    },
    {
        fortune: '中吉',
        categories: {
            総合運: '安定寄り。大外しは少ないが、丁寧さを欠くと急に<br>粗が出る。',
    ...
    },
    {
        fortune: '小吉',
        categories: {
            総合運: '小さな揺れが出やすい。整えれば戻るが、勢い任せ<br>は崩れやすい。',
    ...
    // パターン2
    {
        fortune: '大吉',
        categories: {
            総合運: '応答は滑らか、迷いは少なし。言葉がよく通り、<br>会話の流れを濁らせない。',
    ...
    },
    {
        fortune: '吉',
        categories: {
            総合運: '平の運。型に寄りやすいゆえ、意識して息を入れる<br>と良い。',
    ...
    },
    {
        fortune: '小吉',
        categories: {
            総合運: '小さな引っかかりが出やすい。整えれば戻るが、<br>勢い任せは乱れやすい。',
    ...
    },
    {
        fortune: '末吉',
        categories: {
            総合運: '揺れやすし。焦るほど噛み合いが乱れるので、落ち<br>着いて整える。',
...
const AI_CATEGORIES = ['総合運', '推論運', '共感運', '創作運', '恋愛運'];
